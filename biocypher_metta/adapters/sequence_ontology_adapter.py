...
class SequenceOntologyAdapter(OntologyAdapter):
    ...
    def __init__(self, write_properties, add_provenance, ontology, type, label='sequence_type', dry_run=False, add_description=False, cache_dir=None):
    ...
    def get_uri_prefixes(self):
        ...
        return {
            'primary': 'http://purl.obolibrary.org/obo/SO_',
        }
